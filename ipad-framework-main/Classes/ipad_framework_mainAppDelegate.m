//
//  ipad_framework_mainAppDelegate.m
//  ipad-framework-main
//
//  Created by Nami on 5/14/11.
...
@implementation ipad_framework_mainAppDelegate
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSString *modelPath = [[NSBundle mainBundle] pathForResource:@"ipad_framework_main" ofType:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [NSURL fileURLWithPath: [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"ipad_framework_main.sqlite"]];
